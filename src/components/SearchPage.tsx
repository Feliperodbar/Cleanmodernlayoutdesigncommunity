          ...
          <Card className="shadow-lg">
            <CardContent className="p-12">
              <div className="text-center mb-8">
                <ImageWithFallback
                  src="/build/assets/atend.png"
                  alt="Painel de Atendimento"
              ...
              <div className="mt-10 space-y-4">
                <div className="grid m-4 relative z-4 grid-cols-2 md:grid-cols-4 gap-3">
                  <Button
                    className="h-12 w-full justify-start gap-2"
                    variant="outline"
                    onClick={onQuickSecondBill}
                  >
